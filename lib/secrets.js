...
// spokes nobody had migrated into the tenant model yet. Once this hub went
// live with a publicly-reachable deployment (both the Vercel endpoint and
// its gas/ twin), that same fallback meant any caller on the internet could
// name an arbitrary owner/repo and have this hub fetch it with
// GLOBAL_GITHUB_TOKEN. Returns null now instead, so callers (see
// api/autonomous_agent.js's and gas/autonomous_agent.js's own
// tenant-resolution comments) can reject an unmatched spoke outright.

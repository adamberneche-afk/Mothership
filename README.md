...
| `DASHBOARD_BASE_URL` | e.g., `https://mothership.example.com` | Optional - if set, the suspension email links directly to `install.html`; if unset, the email gives plain-text reinstall guidance instead of a guessed/broken link. |
